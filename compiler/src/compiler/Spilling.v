  ...
  Proof.
    ...
    - (* exec.seq *)
      ...
      + cbn. intros. fwd. eapply exec.weaken.
        -- eapply IH2; eauto.
        -- cbv beta. intros. destruct H1 as [t1' [m1'1 [l1'1 [mc1'1 [t1''1 [t2''1 [R [Hpost [E1 [E2 [F'1 CT]]]]]]]]]]]. subst.
           ...
           blia.
    - (* exec.skip *)
      eapply exec.skip. do 6 eexists. repeat (split; [eauto|]). 1: instantiate (1 := nil).
